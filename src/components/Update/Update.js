        ...
        <section>
            ...
            <div className="flex align-middle justify-center m-10">
                <div className="container border rounded-xl justify-center p-10 align-middle">
                    <div className="mb-6">
                        <label htmlFor="product_id" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Product Id</label>
                    ...
                    <div className="mb-6">
                        <label htmlFor="quatity" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Quatity</label>
